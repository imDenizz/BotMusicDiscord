...
module.exports = {
    info: {
        name: "play",
        description: "Pour jouer des chansons :D",
    ...
    run: async function (client, message, args) {
        ...
        if (serverQueue) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("La chanson a été ajoutée à la file d'attente", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
                .setThumbnail(song.img)
                .setColor("YELLOW")
                .addField("Name", song.title, true)
                .addField("Durée", song.duration, true)
                .addField("Demandé", song.req.tag, true)
